...
import com.msd.auto.models.Action;
import com.msd.auto.models.SaveCustomeMessage;
...
public class MyNotifiService extends NotificationListenerService {
    ...
    public static final String TAG = "Msd";
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        if (action != null) {
            ...
            try {
                ...
                if (
                        sbn.getPackageName().equalsIgnoreCase("com.whatsapp.w4b") ||
        ...
        try {
            ...
            if (sbn.getNotification().tickerText != null) {
                ...
                Log.e("INFO", "Get Message" + "-----" + nMessage);
                Log.e("INFO APP",sbn.getPackageName().toString());
    ...
    private void init() {
      ...
      //  list = ArrayList(realm.where(SaveCustomeMessage::class.java));
        ...
        try {
            ...
            Log.d("INFO", "BufferedWriter Initialization error");
        }
